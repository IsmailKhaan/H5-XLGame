  ...
  <view class="main">
    <view class="content">
      ...
      <view class="signup_instructions f-c"
        >{{ $t("reset_password.reset_subTitle") }}
      </view>
        ...
        <view class="forminpu">
          <view class="input">
            <input
              ...
              :placeholder="$t('reset_password.reset_newPassword')"
          ...
          <view :class="passtip == 1 ? 'passtip' : 'hide passtip passtips'">{{
            $t("rules.password")
          }}</view>
          <view class="input">
            <input
              :type="isshowpass2 == 0 ? 'password' : 'text'"
              @input="getvalue"
              maxlength="12"
              :value="newPasswords"
              @blur="okformdata"
              data-type="newPasswords"
          ...
          <view :class="passstip == 1 ? 'passtip' : 'hide passtip passtipss'"
            >{{ $t("rules.new_password") }}
          </view>

          <view class="getpass f-c" @click="setpassword">{{
            $t("reset_password.reset_now")
          }}</view>
        </view>
      </view>
    </view>

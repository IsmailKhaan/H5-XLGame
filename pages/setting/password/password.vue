  ...
  <view class="password set-bg">
    <view class="background_lock">
      ...
      <view class="form">
        <view class="forminpu">
          ...
          <view class="regBtn" @click="xzClick(1)">{{
    ...
    <view v-show="userFeedbackHidden" class="maskLayer">
      <view class="popup_content">
        ...
        <view class="f-a qer">
          <view class="title_1 f-c" @click="btnLink(0)">{{
            $t("confirm_dialog.cancel")
          }}</view>
          <view class="title_2 f-c" @click="btnLink(1)">{{
    ...
    <view v-show="userFeedbackHidden2" class="maskLayer2">
      <view class="popup_content2">
        ...
        <view class="ner2">{{
          $t("confirm_dialog.after_password_changed")
        }}</view>
        <view class="f-a qer2">
          <view class="title_1 f-c" @click="goto()">{{
...
.password {
  ...
  .maskLayer2 {
    ...
    .popup_content2 {
      ...
      .image_top2 {
        background: url("../../../static/change-password/dead-pool.png")
          no-repeat;
      ...
      .forminpu {
        .input {
          ...
          .input_text {
            ...
            outline: none;
            border: none;
            border-bottom: 2px solid #003b3d;
            padding-left: 32rpx;
          }
